public class KruskalMST {
	...
	// Section: 1
	// Assignment: 4
	// Description: This class define KruskalMST class
	// -----------------------------------------------------
	...
	public KruskalMST(EdgeWeightedGraph G) {
		...
		// graph.
		// Precondition: EdgeWeightedGraph G
	...
	public Iterable<Edge> edges() {
		// --------------------------------------------------------
		// Summary: Returns the edges in a minimum spanning tree (or forest).
		// Precondition: There is no precondition.
		// Postcondition: Returns the edges in a minimum spanning tree (or forest)..
		// --------------------------------------------------------
		return mst;
	}
	...
	public double weight() {
		...
		// forest).
		// Precondition: There is no precondition.
		// Postcondition:Returns the sum of the edge weights in a minimum spanning tree
		// (or forest).
		// --------------------------------------------------------
		return weight;
	}
